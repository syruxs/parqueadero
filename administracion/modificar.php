...
<title>Modificar Expedientes</title>
		<script src="../js/jquery-3.6.0.js"></script>
		<script src="../js/jquery.mask.js"></script>
		<script>
		$(document).ready(function () {
			$(this).val(jQuery.trim($(this).val()));
			$('#tel').mask('+560-00000000');
		});
		</script>
		<style>
		#titulo{
...
<body>
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="2">
		<tr>
			<td>
				<h1 class="animate__animated animate__backInLeft" id="titulo">Modificar Expedientes</h1>
			</td>
		</tr>
		<tr>
			<td>
				<form action="modificar.php" method="post" name="buscar">
	...
	<?php
	    ...
	    if(mysqli_num_rows($sql_recibir) == 0){

        echo "<script type=\"text/javascript\">alert(\"No se han encontrado datos.\");</script>";
	...
	<br>
	<input type="submit" value="GUARDAR" title="GUARDAR CAMBIOS">
	</form>
			';
		}
	}
